    ...
    Statement = [
      {
        ...
        Resource = "arn:aws:codeconnections:us-east-1:407036964001:connection/66e19bfb-ab36-41fc-ac4c-2d8dc493149e"
      },
      {
        Sid    = "CodeBuild"
        Effect = "Allow"
...
resource "aws_codepipeline" "application" {
  ...
  stage {
    ...
    action {
      ...
      configuration = {
        ConnectionArn    = "arn:aws:codeconnections:us-east-1:407036964001:connection/66e19bfb-ab36-41fc-ac4c-2d8dc493149e"
        FullRepositoryId = "Naveen281991/AWS-Real-Time-CI-CD-Deployment-Platform0.1.0"
        BranchName       = "main"
        DetectChanges    = "true"
      }
    }
